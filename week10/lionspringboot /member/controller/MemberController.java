package com.springbootbackend.lionspringboot.member.controller;

import com.springbootbackend.lionspringboot.member.dto.*;
import com.springbootbackend.lionspringboot.member.domain.Member;
import com.springbootbackend.lionspringboot.member.dto.*;
import com.springbootbackend.lionspringboot.member.service.MemberService;
...
public class MemberController {
    ...
    // GET /members  (전체 조회)
    // 변경 후 — part 파라미터를 선택적으로 받는다
    @GetMapping
    public ResponseEntity<List<MemberResponse>> getAllMembers(
            @RequestParam(required = false) String part) {
        List<MemberResponse> responses = memberService.findMembers(part)
